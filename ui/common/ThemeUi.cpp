/**
 * @file ThemeUi.cpp
 * @brief Implementation of theme UI helper functions.
 *
...
QIcon buildModeIcon(const QPalette& palette, Theme::Mode mode, int baseSize) {
...
void ui::common::theme_ui::applyNavigationTheme(const QPalette& palette,
...
void ui::common::theme_ui::applyThemeToggleAppearance(const QPalette& palette,
                                                      QMenuBar* menuBar,
                                                      QStyle* style,
