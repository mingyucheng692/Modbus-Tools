/**
 * @file CollapsibleSection.cpp
 * @brief Implementation of CollapsibleSection.
 * 
...
CollapsibleSection::CollapsibleSection(infra::config::ISettingsService* settingsService, QWidget* parent)
    : QWidget(parent),
