...
TEST_F(FrameParserTest, ParseRtuResponseSuccess) {
    ...
    ParseResult result = parse(frame, ProtocolType::Rtu, 40001, 2);
...
TEST_F(FrameParserTest, ParseRtuCrcError) {
    ...
    ParseResult result = parse(frame, ProtocolType::Rtu);
...
TEST_F(FrameParserTest, ParseTcpRequestSuccess) {
    ...
    ParseResult result = parse(frame, ProtocolType::Tcp);
...
TEST_F(FrameParserTest, ByteOrderTransformation) {
    ...
    ParseResult resABCD = parse(QByteArray::fromHex("010304123456788107"), ProtocolType::Rtu, 40001, 2, false, RegisterOrder::ABCD);
    ...
    applyRegisterOrder(resDCBA, RegisterOrder::DCBA);
